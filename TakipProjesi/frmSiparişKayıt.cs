...
{
    public partial class frmSiparişKayıt : Form
    {
        public frmSiparişKayıt()
        {
            InitializeComponent();
        }
        ...
        private void frmSiparişKayıt_Load(object sender, EventArgs e)
        {
            KategoriGetir();
        }
        ...
        private void btnYeniEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("insert into urun(barkodno,kategori,marka,urunadi,miktari,alisfiyati,satisfiyatı,tarih) values (@barkodno,@kategori,@marka,@urunadi,@miktari,@alisfiyati,@satisfiyatı,@tarih)", baglanti);
        ...
        private void BarkodNotxt_TextChanged(object sender, EventArgs e)
        {
            ...
            while (read.Read())
            {
                ...
                SatışFiyatıtxt.Text = read["satisfiyatı"].ToString();
            }
            baglanti.Close();
        }
        ...
        private void btnVarOLanEkle_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Var olan siparişe ekleme yapıldı.");
        }
    }
}
